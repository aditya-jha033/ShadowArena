...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      mintAsset: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`mintAsset: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const owner_0 = args_1[1];
        const metaHash_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mintAsset',
                                     'argument 1 (as invoked from Typescript)',
                                     'assets.compact line 18 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(owner_0).concat(_descriptor_1.toValue(metaHash_0)),
        ...
        const result_0 = this._mintAsset_0(context,
                                           partialProofData,
                                           owner_0,
                                           metaHash_0);
      ...
      transferAsset: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`transferAsset: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const assetId_0 = args_1[1];
        const newOwner_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transferAsset',
                                     'argument 1 (as invoked from Typescript)',
                                     'assets.compact line 28 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(assetId_0) === 'bigint' && assetId_0 >= 0n && assetId_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('transferAsset',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'assets.compact line 28 char 1',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(assetId_0).concat(_descriptor_1.toValue(newOwner_0)),
    ...
    this.impureCircuits = {
      mintAsset: this.circuits.mintAsset,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('mintAsset', new __compactRuntime.ContractOperation());
  ...
  _mintAsset_0(context, partialProofData, owner_0, metaHash_0) {
    const assetId_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_6.toValue(1n),
                                                                  alignment: _descriptor_6.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(assetId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(assetId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(metaHash_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('assets.compact line 25 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(assetId_0 + 1n);
    __compactRuntime.queryLedgerState(context,
  ...
  _transferAsset_0(context, partialProofData, assetId_0, newOwner_0) {
    const pubAssetId_0 = assetId_0;
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_6.toValue(1n),
                                                                                                                  alignment: _descriptor_6.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pubAssetId_0),
                                                                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { idx: { cached: false,
                                                                                                              ...
                                                                                                              path: [
                                                                                                                     { tag: 'value',
                                                                                                                       value: { value: _descriptor_0.toValue(pubAssetId_0),
