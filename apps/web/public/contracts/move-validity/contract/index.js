...
(function (GameState) {
  GameState[GameState['WAITING_P1'] = 0] = 'WAITING_P1';
  GameState[GameState['WAITING_P2'] = 1] = 'WAITING_P2';
  GameState[GameState['REVEAL'] = 2] = 'REVEAL';
...
const _descriptor_4 = new __compactRuntime.CompactTypeUnsignedInteger(10n, 1);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      joinPlayer1: (...args_1) => {
        ...
        const result_0 = this._joinPlayer1_0(context,
                                             partialProofData,
                                             commitment_0);
      ...
      joinPlayer2: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`joinPlayer2: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const commitment_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._joinPlayer2_0(context,
                                             partialProofData,
                                             commitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      ...
      reveal: (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`reveal: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const p1Value_0 = args_1[1];
        const p1Nonce_0 = args_1[2];
        const p2Value_0 = args_1[3];
        const p2Nonce_0 = args_1[4];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(p1Value_0).concat(_descriptor_2.toValue(p1Nonce_0).concat(_descriptor_4.toValue(p2Value_0).concat(_descriptor_2.toValue(p2Nonce_0)))),
            alignment: _descriptor_4.alignment().concat(_descriptor_2.alignment().concat(_descriptor_4.alignment().concat(_descriptor_2.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = this._reveal_0(context,
                                        partialProofData,
                                        p1Value_0,
                                        p1Nonce_0,
                                        p2Value_0,
    ...
    this.impureCircuits = {
      joinPlayer1: this.circuits.joinPlayer1,
      joinPlayer2: this.circuits.joinPlayer2,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('joinPlayer1', new __compactRuntime.ContractOperation());
    state_0.setOperation('joinPlayer2', new __compactRuntime.ContractOperation());
  ...
  _callerAddress_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('callerAddress',
                                 'return value',
                                 'move-validity.compact line 15 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _joinPlayer1_0(context, partialProofData, commitment_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            0,
                            'Not waiting for P1');
    const tmp_0 = this._some_0(this._callerAddress_0(context, partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(tmp_0),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_1 = this._some_0(commitment_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _joinPlayer2_0(context, partialProofData, commitment_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
            ...
            p2Nonce_0)
  {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            2,
                            'Not in reveal state');
    const p1Expected_0 = this._makeCommitment_0(p1Value_0, p1Nonce_0);
    const p2Expected_0 = this._makeCommitment_0(p2Value_0, p2Nonce_0);
    ...
    __compactRuntime.assert(this._equal_1(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value).value,
                                          p2Expected_0),
                            'P2 commitment mismatch');
    const pub1_0 = p1Value_0;
    const pub2_0 = p2Value_0;
    if (pub1_0 > pub2_0) {
